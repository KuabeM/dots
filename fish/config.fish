...
set CMAKKE_BUILD_PARALLEL_LEVEL 8
set MAKEFLAGS '-j 8'
set PAGER 'less -R'
set EDITOR 'vim'

set CARGO_TARGET_AARCH64_UNKNOWN_LINUX_GNU_LINKER /opt/aarch64-brainlab-linux-gnu-13.2-kernel5.4/bin/aarch64-brainlab-linux-gnu-gcc
set CC_aarch64_unknown_linux_gnu /opt/aarch64-brainlab-linux-gnu-13.2-kernel5.4/bin/aarch64-brainlab-linux-gnu-gcc
